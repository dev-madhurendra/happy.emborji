  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="relative h-60 w-full overflow-hidden bg-gray-100 flex-shrink-0"
      >
        <img
          src={
            images[0] ||
      ...
      <div className="space-y-3 p-4">
        ...
        <div className="grid grid-cols-2 gap-2 pt-2">
          ...
          <Button
            variant="outline"
            className="border-2 border-pink-200 bg-gradient-to-r from-pink-50 to-purple-50 px-3 py-2 text-xs font-bold text-pink-700 transition-all hover:scale-105 hover:border-pink-300 hover:shadow-md"
            onClick={() => navigate(`/product/${product._id}`)}
          >
            Details
          </Button>
